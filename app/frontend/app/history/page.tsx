...
export default function HistoryPage() {
  ...
  return <div className="mx-auto max-w-4xl space-y-8 pb-16"><header><p className="text-[10px] font-bold uppercase tracking-[.2em] text-[#8c6325]">Employee work log</p><h1 className="mt-3 text-4xl font-semibold tracking-[-.045em]">History</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-muted">What DINKLY created, reviewed, learned, and handed back—across the web workspace, Slack, and scheduled work.</p></header>
